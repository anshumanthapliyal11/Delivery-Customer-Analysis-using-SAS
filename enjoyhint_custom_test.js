var EnjoyHint = function (_options) {
            ...
            if (!step_data.selector) {
                ...
                for (var prop in step_data) {
                    ...
                    if (step_data.hasOwnProperty(prop) && prop.split(" ")[1]) {
                        ...
                        step_data.selector = prop.substring(prop.indexOf(' '), prop.length).trim();
    ...
    window.addEventListener('resize', function() {
        ...
        if ($event_element != null && $event_element[0] != null) {
            ...
            return this.each(function () {
                ...
                $(window).on('resize', function() {
                    ...
                    if (that.stepData != null) {
                        ...
                        var labelRect;
                        if (labelElement && labelElement[0]) {
                            labelRect = labelElement[0].getBoundingClientRect();
                        }
